...
import type { CompanySupportRow, ExerciseRow, Gender, MentalHealthRow, PainAreaCode, QqConditionId, QqConditionItem, SecondPartData, SurveyResponse, SurveyRound, WorkLifeRow } from "./types";
